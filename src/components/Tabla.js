...
<div className="overflow-x-auto">
        <div className="min-w-screen min-h-screen bg-trueGray-100 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
                        ...
                        <tbody className="text-gray-600 text-sm font-light">
                            <tr className="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td className="py-3 px-6 text-left">
                                    <div className="flex items-center">
                                        <div className="mr-2">
                                            <img className="w-6 h-6 rounded-full" src="https://randomuser.me/api/portraits/men/1.jpg" alt="img" />
                                        </div>
